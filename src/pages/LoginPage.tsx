    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center px-4">
      <div className="w-full max-w-3xl overflow-hidden rounded-3xl border border-slate-800 bg-slate-900/80 shadow-2xl backdrop-blur">
        <div className="grid gap-0 md:grid-cols-2">
          <div className="hidden md:block bg-gradient-to-br from-emerald-500/70 via-emerald-400/40 to-emerald-300/20 p-10">
            <div className="flex h-full flex-col justify-between text-emerald-950">
              <div>
              ...
              <div className="mt-10 space-y-4 text-sm text-emerald-100/90">
