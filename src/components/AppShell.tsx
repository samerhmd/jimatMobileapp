...
const baseClass =
  'relative px-2 py-1 text-sm font-medium text-slate-200 transition hover:text-emerald-300 after:absolute after:-bottom-1 after:left-0 after:h-0.5 after:w-0 after:bg-emerald-400/60 after:transition-all after:duration-300'
